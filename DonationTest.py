...
class Page:
    def __init__(self, site_url, expected_monthy_checkbox_text, expected_donations_amount, expected_currency_symbol,
                 expected_thankyou, expected_label_name, expected_label_phone, expected_label_email):
        ...
        self.expected_thankyou = expected_thankyou
...
class DonationTest(unittest.TestCase):
    ...
    def test_donation_form(self):
        ...
        pages = [
            Page("https://animals-now.org/donate/" + params, "תרומה חודשית", ["50", "120", "200", "400"], "₪", "תודה!",
                 "שם מלא:", "טלפון:", "אימייל:"),
            Page("https://animals-now.org/en/donate/" + params, 'Monthly Donation', ["25", "35", "50", "100"], "$",
                 "Thank you!", 'Full Name', 'Phone Number', 'Email Address'),
            ...
            Page("https://challenge22.com/es/donate/" + params, "Donación mensual", ["25", "35", "50", "100"], "$",
                 '¡Gracias!', 'Nombre completo', "Numero de telefono", 'Email')
        ]
        driver = self.driver
        for page in pages:
            print(page.site_url)
            ...
            self.go_to_2nd_page()
            self.verify_texts_on_2nd_page(page.expected_thankyou, page.expected_label_name, page.expected_label_phone,
    ...
    def verify_texts_on_2nd_page(self, expected_thankyou, expected_label_name, expected_label_phone, expected_label_email):
        driver = self.driver
        thankyou = driver.find_element_by_css_selector("#h > h1").text
        ...
        self.assertIn(expected_thankyou, thankyou)
